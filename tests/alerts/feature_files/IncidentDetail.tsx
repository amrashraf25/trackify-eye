...
// Shows the full details and video clip for a single incident, identified by the :id URL parameter.
            ...
            <CardContent>
              <div className="aspect-video bg-secondary rounded-lg flex items-center justify-center border border-border">
                {incident.video_clip_url ? (
                  <video controls className="w-full h-full rounded-lg" src={incident.video_clip_url}>
