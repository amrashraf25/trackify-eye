with open('src/components/doctors/DoctorAttendanceSection.tsx', 'r', encoding='utf-8') as f:
    src = f.read()
...
with open('src/components/doctors/DoctorAttendanceSection.tsx', 'w', encoding='utf-8') as f:
    f.write(result)
