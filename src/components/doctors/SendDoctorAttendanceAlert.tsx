// Button + dialog that lets the dean send an attendance-rate warning notification to a specific doctor.
...
const SendDoctorAttendanceAlert = ({ doctorId, doctorName, attendanceRate }: SendDoctorAttendanceAlertProps) => {
  ...
  // Pre-fill the message with the current attendance rate; the sender can override it
  ...
  // Insert a notification record that will be delivered to the doctor in real time
