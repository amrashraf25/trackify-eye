// Bar chart showing average attendance rate per active course on the dashboard.
...
const AttendanceChart = () => {
  ...
  // Fetch up to 6 active courses and compute each course's attendance rate
  const { data: chartData = [] } = useQuery({
    ...
    queryFn: async () => {
      ...
      // Calculate present percentage for each course; truncate long names for axis labels
  ...
  // Fall back to a placeholder entry when no data is available yet
