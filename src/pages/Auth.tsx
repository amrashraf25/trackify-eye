...
// Login page with animated owl mascot, demo account shortcuts, and a cinematic page-transition effect on successful sign-in.
const Auth = () => {
  ...
  // Redirect already-authenticated users to the dashboard immediately on mount.
  useEffect(() => {
  ...
  // Drives the multi-phase animation state machine: idle → hold (220ms pause) → flying (owl zoom + whoosh) → reveal (navigate).
  useEffect(() => {
